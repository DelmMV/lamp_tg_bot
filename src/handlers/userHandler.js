 ...
 */
 ...
 const { saveJoinRequest, saveUserButtonMessage } = require('../db'); 
 ...
 */
 async function handleNewChatMembers(bot, ctx) {
   ...
   try {
     ...
     // Приветственное сообщение в личку пользователю больше не отправляется
     // чтобы избежать дублирования. Если необходимо, вместо удаления можно
     // заменить на другое полезное сообщение с информацией для новых участников.
   } catch (error) {
