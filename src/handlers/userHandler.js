...
async function handleChatJoinRequest(bot, ctx) {
 ...
 Регистрация: ~ ${registrationPeriod}
     `.trim()
		...
		const userMessage = `
 Привет! Получили от тебя заявку на вступление в сообщество МоноПитер https://t.me/eucriders
 ...
 В ожидании одобрения, предлагаю ознакомиться с правилами/ценностями нашего сообщества: http://монопитер.рф/rules#text
