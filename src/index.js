...
bot.on('chat_join_request', async (ctx) => {
  ...
  `;
    ...
    Просим обязательно приложить своё фото с моноколесом, чтобы мы были уверены, что это не очередная попытка зайти в наш чат с недобросовестными намерениями.
