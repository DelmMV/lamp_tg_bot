...
bot.on('chat_join_request', async (ctx) => {
  ...
  `;
    ...
    В связи с информационной атакой, мы вынуждены временно повысить бдительность при подтверждении заявок на вступление в чат.
    
    Просим после подачи заявки ответить на вопросы бота и обязательно приложить к ним своё фото с моноколесом, чтобы мы были уверены, что это не очередная попытка зайти в наш чат с недобросовестными намерениями.
